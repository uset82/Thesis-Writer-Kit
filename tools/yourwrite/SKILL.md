...
# YourWrite: Remove AI Writing Patterns
...
- Inline: "ize this text. Here's a sample of my writing for voice matching: [sample]"
- File: "ize this text. Use my writing style from [file path] as a reference."
